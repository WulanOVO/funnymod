...
import yibo.funnymod.client.render.SuspiciousSnowGolemRenderer;
...
public class FunnymodClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
        ...
        // 注册可疑雪傀儡渲染器
        EntityRenderers.register(ModEntities.SUSPICIOUS_SNOW_GOLEM, SuspiciousSnowGolemRenderer::new);
	}
}